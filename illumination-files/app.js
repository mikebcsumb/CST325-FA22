...
function updateAndRender() {
    ...
    //lightDirection
    var translation = new Matrix4().makeTranslation(0, 2, 0);
    if(appInput.a) {
        console.log("AAAAAA")
        lightDirection.set(lightDirection.x - 0.1, lightDirection.y, lightDirection.y);
    }

    if(appInput.d) {
        //lightDirection.multiply(translation);
        console.log("DD")
        lightDirection.set(lightDirection.x + 0.1, lightDirection.y, lightDirection.y);
