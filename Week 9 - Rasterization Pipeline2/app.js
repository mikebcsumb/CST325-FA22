...
function updateAndRender() {
    ...
    let colorOffset1 = Math.abs(Math.sin(time.secondsElapsedSinceStart))
    let colorOffset2 = Math.abs(Math.cos(time.secondsElapsedSinceStart))
    //let colorOffset3 = Math.abs(Math.fract(time.secondsElapsedSinceStart))

    //console.log(colorOffset)
    gl.uniform4f(colorProgram.uniforms.colorUniform, 1.0 - colorOffset1, 1.0 - colorOffset2, colorOffset1, 1.0);
